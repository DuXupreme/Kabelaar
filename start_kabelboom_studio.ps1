$scriptPath = Join-Path $PSScriptRoot "kabelboom_studio.py"
...
Write-Error @"
Geen Python-installatie gevonden voor Kabelboom Studio.
...
Start daarna opnieuw via start_kabelboom_studio.bat.
"@
exit 1
